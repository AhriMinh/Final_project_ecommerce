            ...
            {productData.map((item) => (
                ...
                className='flex items-center justify-between gap-6 mt-6'>
                    <div className='flex items-center gap-2'>
                        <AiOutlineClose onClick={() => dispatch(deleteItem(item._id))&toast.error(`${item.title} is removed`)} className='text-xl text-gray-600 hover:text-red-600 cursor-pointer duration-300'/>
